...
def main(argv):
    ...
    parser.add_argument('-predictions_file', default = 'C:\\darknet\\build\\darknet\\x64\\results\\20K-vis-768-comp4_det_test_person.txt', # This dir name I cannot change cuz it will cause confusion 
                        help='path to yolo predictions\n', )
    
    parser.add_argument('-caltech_pedestrian_root', default = 'E:\\dataset\\CaltechPedestrians\\code\\data-USA\\res\\caltech-20K-vis-768',  
